...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='category',
            name='file',
            field=models.ImageField(max_length=80, upload_to=blog.utils.rename_path, validators=[blog.validators.file_size, blog.validators.invalid_characters, blog.validators.pil_verify_image, blog.validators.resize_image], verbose_name='File'),
        ),
        migrations.AlterField(
            model_name='historicalcategory',
            name='file',
            field=models.TextField(max_length=80, validators=[blog.validators.file_size, blog.validators.invalid_characters, blog.validators.pil_verify_image, blog.validators.resize_image], verbose_name='File'),
        ),
        migrations.AlterField(
